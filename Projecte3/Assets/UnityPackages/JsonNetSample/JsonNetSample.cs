...
//        public string[] Sizes;
//        public Dictionary<string, SaveableContainer> dic = new Dictionary<string, SaveableContainer>();
...
//        //WriteLine(c.Id + " " + c.Name+" "+c.dic);
//        //CharacterListItem item = new CharacterListItem();
//        ////item.dic.Add("sss", "mmmm");
//        //string json2 = JsonConvert.SerializeObject(item);
//        //Debug.Log(json2);
//    }
...
//        SaveableContainer ss=new SaveableContainer();
//        ss.Start("Menu2");
//        product.dic.Add("ssss", ss);
