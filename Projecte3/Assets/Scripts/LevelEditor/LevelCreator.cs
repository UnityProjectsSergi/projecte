...
namespace LevelEditor
{
    public class LevelCreator : MonoBehaviour
    {
                ...
                if(startNode_Wall != null && endNodeWall != null)
                {
                    ...
                    if(difX != 0 && difZ != 0)
                    {
                        ...
                        else
                        {
                            ...
                            if(startNode_Wall.nodePosX > endNodeWall.nodePosX)
                            {
                                Node northeWestNode = DestroyCurrentNodeAndGetPrevious(finalZNode, true);
        ...
        void CreateWallInNode(int posX, int posZ, Level_WallObj.WallDirection direction)
        {
            ...
            if(getNode.wallObj == null)
            {
                GameObject actualObjPlaced = Instantiate(wallPrefab, wallPosition, Quaternion.identity);
                LevelObject placedObjProperties = actualObjPlaced.GetComponent<LevelObject>();
